...
/**
 * JVM/Desktop implementation of image exporter using AWT file dialogs.
 */
class JvmImageExporter : ImageExporter {
    ...
    private suspend fun showSaveDialog(suggestedName: String): File? = withContext(Dispatchers.IO) {
        ...
        SwingUtilities.invokeLater {
            ...
            result = if (directory != null && file != null) {
                File(directory, file)
            } else {
                null
            }
